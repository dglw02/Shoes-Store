<?php
	$rowPerPage = 10; //Số order trên 1 trang.
							...
							<table 
                            	...
                            	?> 
									<tr>
										...
										<td style=""><?php echo $row['ord_date'] ?></td>
										...
										<td class="form-group">
											...
											<a onclick="return confirmEdit();" href="index.php?page=order_edit&ord_id=<?php echo $row['ord_id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
											<a onclick="return confirmDel();" href="index.php?page=order_del&ord_id=<?php echo $row['ord_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
										</td>
									</tr>
								<?php         
                                    }
...
<script>
	...
	function confirmEdit() {
        return confirm("Bạn có chắc chắn muốn chuyển đơn hàng thành đã xử lí?");
    }
</script>
<script>
function myFunction() {
