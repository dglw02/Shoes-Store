...
<title>Foot Shop - Administrator</title>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Foot</span>Shop</a>
				<ul class="user-menu">
	...
	if(isset($_GET['page'])) {
		switch ($_GET['page']) {
			...
			case 'order_detail':
				...
				break;
			case 'order_edit':
				require_once "modules/orders/order_edit.php";
				break;
			case 'order_del':
				require_once "modules/orders/order_del.php";
				break;
		}
	}else{
